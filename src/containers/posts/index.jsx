...
const postData = [
    ...
    },
    {
        ...
        text: "МеньшиПозволяет независимо подстраивать реакцию подвески на ускорение и тормозное усилие. Это означает, что вы получаете более уверенный контроль, когда  это  больше всего необходимо."
    },
    {
        id: 3,
        image: Post3,
